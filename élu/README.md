...
- Chaque fichier contient :
  ...
  - Le résumé complet
  - Les concepts clés et points stratégiques
  - Pourquoi cet article est crucial pour le PFE

> Ce dossier sert de **répertoire de référence pour les articles à citer dans le rapport et à présenter lors de la soutenance**.
